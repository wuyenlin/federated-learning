...
After $E$ epochs, the updated weights $w_k$ are sent to the server. The server then combines the weights of the clients to obtain a new model $w_{t+1}$. This is done by assigning a higher weight to clients with a larger fraction of data.
